...
<style>
    ...
    /* --- BADGES UTILISATEURS (BLEU GARÇON / ROSE FILLE) --- */
    ...
    .girl-card button, div.girl-card button {
        ...
        font-weight: 900 !important;
        border-radius: 20px !important;
        box-shadow: 0 12px 28px rgba(219, 39, 119, 0.5) !important;
        margin-bottom: 12px !important;
    }

    /* --- SPECTRE DE DÉGRADÉ CONTINU DES ZONES 1 À 10 --- */
    .z-color-0 button, div.z-color-0 button { background: linear-gradient(135deg, #0284C7, #38BDF8) !important; border: 2px solid #7DD3FC !important; border-bottom: 6px solid #0369A1 !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-1 button, div.z-color-1 button { background: linear-gradient(135deg, #0D9488, #2DD4BF) !important; border: 2px solid #5EEAD4 !important; border-bottom: 6px solid #0F766E !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-2 button, div.z-color-2 button { background: linear-gradient(135deg, #059669, #34D399) !important; border: 2px solid #6EE7B7 !important; border-bottom: 6px solid #047857 !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-3 button, div.z-color-3 button { background: linear-gradient(135deg, #65A30D, #A3E635) !important; border: 2px solid #BEF264 !important; border-bottom: 6px solid #4D7C0F !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-4 button, div.z-color-4 button { background: linear-gradient(135deg, #D97706, #FBBF24) !important; border: 2px solid #FDE68A !important; border-bottom: 6px solid #B45309 !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-5 button, div.z-color-5 button { background: linear-gradient(135deg, #EA580C, #FB923C) !important; border: 2px solid #FDBA74 !important; border-bottom: 6px solid #C2410C !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-6 button, div.z-color-6 button { background: linear-gradient(135deg, #DC2626, #F87171) !important; border: 2px solid #FCA5A5 !important; border-bottom: 6px solid #B91C1C !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-7 button, div.z-color-7 button { background: linear-gradient(135deg, #E11D48, #FB7185) !important; border: 2px solid #FDA4AF !important; border-bottom: 6px solid #BE123C !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-8 button, div.z-color-8 button { background: linear-gradient(135deg, #7C3AED, #C084FC) !important; border: 2px solid #E9D5FF !important; border-bottom: 6px solid #6D28D9 !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }
    .z-color-9 button, div.z-color-9 button { background: linear-gradient(135deg, #4F46E5, #818CF8) !important; border: 2px solid #C7D2FE !important; border-bottom: 6px solid #3730A3 !important; color: #FFF !important; height: 75px !important; font-size: 22px !important; font-weight: 900 !important; border-radius: 20px !important; margin-bottom: 12px !important; }

    /* --- BOUTONS DE VOTE D'AUDIT (OUI / NON / N/A) CIBLÉS SPÉCIFIQUEMENT --- */
